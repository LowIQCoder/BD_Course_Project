// ORM class for table 'dim_taxi'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon May 11 22:14:22 MSK 2026
...
public class dim_taxi extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("taxi_id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        dim_taxi.this.taxi_id = (Integer)value;
      }
    });
  }
  public dim_taxi() {
  ...
  public dim_taxi with_taxi_id(Integer taxi_id) {
    this.taxi_id = taxi_id;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof dim_taxi)) {
      return false;
    }
    dim_taxi that = (dim_taxi) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.taxi_id = JdbcWritableBridge.readInteger(1, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(taxi_id, 1 + __off, 4, __dbStmt);
    return 1;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    dim_taxi o = (dim_taxi) super.clone();
    return o;
  }

  public void clone0(dim_taxi o) throws CloneNotSupportedException {
  }
